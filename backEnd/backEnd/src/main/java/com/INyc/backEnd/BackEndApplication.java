...
public class BackEndApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			Arts arts2 = new Arts(2, "Carter Burden Gallery", "548 W 28th St #534", Location.MANHATTAN, "Blue Journey", "Ellen Wallenstein",Date.valueOf("2024-08-01" ),Date.valueOf("2024-11-06") ,"FREE","https://res.cloudinary.com/djsguemrp/image/upload/v1726505101/Blue_oybwsn.png");
			...
			List<Arts> arts = List.of(arts1, arts2, arts3, arts4);
				...
				Restaurants restaurants2 = new Restaurants(2, "Win Son", "159 Graham Ave.", Location.BROOKLYN, "Taiwanese", "Chicken Sandwich", "NO", "50+", "https://res.cloudinary.com/djsguemrp/image/upload/v1726505102/Winson_apsqfl.jpg");
				Restaurants restaurants3 = new Restaurants(3, "Roccos", "115-10 Rockaway Blvd", Location.QUEENS, "Italian", "Grilled Octopus", "NO", "50+", "https://res.cloudinary.com/djsguemrp/image/upload/v1726516187/Rocco_ajaguw.png");
				Restaurants restaurants4 = new Restaurants(4, "Cornbread Soul Kitchen", "409 Eastern Parkway", Location.BROOKLYN, "Soul Food", "Cornbread", "NO", "25+", "https://res.cloudinary.com/djsguemrp/image/upload/v1726505101/Cornbread_n9abdg.jpg");
				Restaurants restaurants5 = new Restaurants(5, "Hudson", "37 Bruckner Blvd", Location.THE_BRONX, "BBQ", "Brisket", "NO", "25+", "https://res.cloudinary.com/djsguemrp/image/upload/v1726516197/Hudson_lozblu.jpg");
